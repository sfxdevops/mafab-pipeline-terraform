resource "aws_ecr_repository" "platform-composite-validator-listener-ecr" {
...
#     "--repository-name", "${aws_ecr_repository.platform-composite-validator-listener-ecr.name}",
